(() => {
  ...
  window.Webflow.push(() => {
    ...
    if (nav) {
      let navIsOpen = function() {
        return document.querySelectorAll(".nav_component .w-dropdown-toggle.w--open").length || document.querySelector(".nav_hamburger_close").style.display === "block" ? true : false;
      };
