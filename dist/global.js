(() => {
  ...
  window.Webflow.push(() => {
    ...
    counterElements.forEach((element) => {
      ...
      if (match) {
        ...
        gsapWithCSS.to(obj, {
          ...
          ease: "power3.out",
          // You can change this easing function
          onUpdate: function() {
    ...
    document.querySelectorAll(".bidding-tag_wrapper").forEach((item, index) => {
      ...
      item.append(item.querySelector(".bidding-tag_slide").cloneNode(true));
      let tl = gsapWithCSS.timeline({ repeat: -1, onReverseComplete: () => tl.progress(1) });
      ...
      Observer.create({
        ...
        onChangeY: (self) => {
          ...
          v = gsapWithCSS.utils.clamp(-3, 3, v);
          tl.timeScale(v);
          let resting = 1;
          if (v < 0)
            resting = -1;
