(() => {
  ...
  // node_modules/.pnpm/gsap@3.12.7/node_modules/gsap/gsap-core.js
  ...
  // node_modules/.pnpm/gsap@3.12.7/node_modules/gsap/CSSPlugin.js
  var _win2;
  var _doc2;
  var _docElement;
  var _pluginInitted;
  ...
  // node_modules/.pnpm/gsap@3.12.7/node_modules/gsap/index.js
  var gsapWithCSS = gsap.registerPlugin(CSSPlugin) || gsap;
  var TweenMaxWithCSS = gsapWithCSS.core.Tween;

  // node_modules/.pnpm/gsap@3.12.7/node_modules/gsap/Observer.js
  ...
  // node_modules/.pnpm/gsap@3.12.7/node_modules/gsap/ScrollTrigger.js
  var gsap3;
  var _coreInitted3;
  var _win4;
  var _doc4;
  ...
  window.Webflow.push(() => {
    ...
    let currentIndex = 0;
    gsapWithCSS.set(textRows, { yPercent: 0 });
    function animateText() {
      gsapWithCSS.to(textRows, {
        yPercent: -100,
        duration: 0.9,
        ease: "power3.inOut",
        onComplete: () => {
    ...
    if (tabComponent) {
      let resetStyles = function() {
        gsapWithCSS.set(".autotab_col1", { clearProps: "all" });
        gsapWithCSS.set(".autotab_col2", { clearProps: "all" });
        gsapWithCSS.set(allImages, { clearProps: "all" });
        tabs.forEach((tab) => {
          tab.classList.remove("is-active");
          gsapWithCSS.set(tab.querySelector(".autotab_body"), { clearProps: "all" });
          gsapWithCSS.set(tab.querySelector(".autotab_line-inner"), { clearProps: "all" });
        });
        if (tabs.length) {
        ...
        (function initialize() {
          gsapWithCSS.set(".autotab_col1", { xPercent: -50, opacity: 0 });
          gsapWithCSS.set(".autotab_col2", { x: "-30rem" });
          gsapWithCSS.set(allImages, { opacity: 0, visibility: "hidden" });
          gsapWithCSS.set(allImages[0], { opacity: 1, visibility: "visible" });
          gsapWithCSS.set(lineInners, { height: "0%" });
              ...
              if (idx !== toActiveIndex) {
                tl.to(
                  img,
                  {
                    ...
                    duration: 0.4,
                    ease: "none",
                    onComplete: () => gsapWithCSS.set(img, { visibility: "hidden" })
                  },
                  0
                );
              }
        ...
        tabs.forEach((tab, index) => {
          ...
          const tabTrigger = ScrollTrigger2.create({
            trigger: tabComponent,
            start: sectionStart,
            end: sectionEnd,
            markers: false,
          ...
          const lineTrigger = ScrollTrigger2.create({
            trigger: tabComponent,
            start: sectionStart,
            end: sectionEnd,
            scrub: true,
            onUpdate: (self) => {
              gsapWithCSS.to(lineInner, {
      ...
      }, cleanupScrollTriggers = function() {
